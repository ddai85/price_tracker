...
(function (root, factory) {
  ...
  var exports = function (apiClient) {
    ...
    this.getItemsWithHttpInfo = function (getItemsRequest) {
      ...
      console.log("this is my request", getItemsRequest);
    ...
    this.getItems = function (getItemsRequest) {
      return this.getItemsWithHttpInfo(getItemsRequest).then(function (
        response_and_data
      ) {
        return response_and_data.data;
      });
    ...
    this.searchItems = function (searchItemsRequest) {
      return this.searchItemsWithHttpInfo(searchItemsRequest).then(function (
        response_and_data
      ) {
        return response_and_data.data;
      });
